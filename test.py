...
#
#
# def process_images(input_dir, cycleGan_dir, starGan_dir, validation_csv, output_csv):
...
#
#         if not (os.path.exists(cycleGan_path) and os.path.exists(starGan_path)):
...
#             img_cycleGan_cv = cv2.imread(cycleGan_path)
#             img_starGan_cv = cv2.imread(starGan_path)
#
#             # Resize để đảm bảo cùng kích thước
#             img_cycleGan_cv = cv2.resize(img_cycleGan_cv, (img_input_cv.shape[1], img_input_cv.shape[0]))
#             img_starGan_cv = cv2.resize(img_starGan_cv, (img_input_cv.shape[1], img_input_cv.shape[0]))
#
#             # Tính PSNR và SSIM
...
#
#             if len(input_encoding) == 0 or len(cycleGan_encoding) == 0 or len(starGan_encoding) == 0:
...
#             results.append([
#                 filename,
#                 psnr_cycleGan, ssim_cycleGan, cycleGan_similarity,
#                 psnr_starGan, ssim_starGan, starGan_similarity
#             ])
#
...
#         "Filename",
#         "PSNR_CycleGAN", "SSIM_CycleGAN", "CycleGAN_Similarity",
#         "PSNR_StarGAN1", "SSIM_StarGAN1", "StarGAN1_Similarity"
#     ])
#
...
# starGan_dir = r"C:\Users\tam\Desktop\pythonProject\starGan1"
# validation_csv = r"C:\Users\tam\Desktop\pythonProject\validation.csv"
# output_csv = "combined_results.csv"
#
# # Chạy chương trình
# results = process_images(input_dir, cycleGan_dir, starGan_dir, validation_csv, output_csv)
...
def text_to_speech(text, filename="temp_speech.mp3", language='vi'):
    try:
        pygame.init()  # Khởi tạo toàn bộ pygame, bao gồm cả mixer
        pygame.mixer.init()  # Khởi tạo riêng mixer (đảm bảo)
